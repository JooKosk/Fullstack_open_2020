...
const CreateNew = (props) => {
  ...
  const contentWithReset = useField('text')
  const authorWithReset = useField('text')
  const infowithReset = useField('text')
  const history = useHistory()

  const content = ignoreReset(contentWithReset)
  const author = ignoreReset(authorWithReset)
  const info = ignoreReset(infowithReset)
